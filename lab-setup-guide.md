...
- [  VMware Workstation Pro Installation](#vmware-workstation-pro-installation)
- [Domain Controller (DC01)](#domain-controller-dc01)
  - [  Virtual Machine Setup](#virtual-machine-setup-dc01)
...
- [Client Machine (CLIENT01)](#client-machine-client01)
  - [  Virtual Machine Setup](#virtual-machine-setup-client01)
...
## <h2 id="vmware-workstation-pro-installation">   VMware Workstation Pro Installation </h2>
...
## <h2 id="virtual-machine-setup-dc01">   Virtual Machine Setup </h2>
...
## <h2 id="virtual-machine-setup-client01">   Virtual Machine Setup </h2>
...
**Congrats! You now have a domain-joined client machine!  **
...
## <h2 id="whats-next">   What's Next? </h2>
  ...
  [Jump to the AD Task Walkthrough  ](link-to-ad-tasks-readme)
...
If you find anything confusing or run into trouble, feel free to [open an issue](https://github.com/SubrataDatta1817/Active-Directory-Lab/issues) or email me at  subratadatta3584@gmail.com. Remember, this guide is made by a learner (that's me), for learners (that's you).
